...
internal class Router {
    ...
    init {
        ...
        routeMap.addRoute(RouteDefinition(Method.GET, "/session/:sessionId/appium/execute_mobile/uiautomator_text_dump", UiautomatorTextDump(), AppiumParams::class.java))
