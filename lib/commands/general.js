...
/**
 *  Execute UiAutomator2 command to return the text of all Text views present on the current screen.
 * @throws  {Error} if uiautomator view dump is unsuccessful
 * @returns {string} uiautomator DOM xml as string
 */
commands.mobileUiautomatorTextDump = async function mobileUiautomatorTextDump () {
  return await this.espresso.jwproxy.command(`/appium/execute_mobile/uiautomator_text_dump`, 'GET');
};
